...
class WorkerManager {
    ...
    startBookingWorkers(concurrency = 3) {
        ...
        bookingQueue.process('create-servicetitan-job', concurrency, bookingWorkers.createServiceTitanJob);
    ...
    startNotificationWorkers(concurrency = 2) {
        ...
        notificationQueue.process('send-confirmation', concurrency, notificationWorkers.sendConfirmation);
    ...
    startIntegrationWorkers(concurrency = 2) {
        ...
        integrationQueue.process('sync-external-data', concurrency, integrationWorkers.syncExternalData);
