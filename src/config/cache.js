...
class CacheService {
    ...
    async cacheTimeSlots(zipCode, date, slots, ttl = 300) { // 5 minutes
    ...
    async cacheServiceArea(zipCode, areaData, ttl = 3600) { // 1 hour
    ...
    // Session caching
    async cacheSession(sessionId, sessionData, ttl = 1800) { // 30 minutes
